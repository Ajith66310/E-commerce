...
const SendMail = () => {
  ...
  const handleVerifyOtp = async (e) => {
    try {
      e.preventDefault();
      const response = await axios.post(`${import.meta.env.VITE_URL}/resetotpverify`, { email, otp })
      ...
      {otpSended ? (
        ...
        >
          ...
          <div className='flex flex-col gap-3'>
            ...
            />
            <p className='text-sm text-blue-700 cursor-pointer hover:underline'>Resend OTP</p>
          </div>
