      ...
      <div className='pt-20 flex h-[89vh] justify-center bg-[#FAF9F6]'>
        <form action="" method='' className=' w-[80%] h-120'>
          <div className='flex justify-center items-center  mt-10 mb-5 flex-col gap-1'>
            ...
            <label className='font-bold text-red-600 w-100  font-[Lato] '>Username/email</label>
            <input type="text" placeholder='Username/email' className='pl-2 placeholder:font-bold  border mb-3 rounded w-100 h-10  focus:outline-red-600 ' />
            <label className='font-bold font-[Lato] text-red-600 w-100'>Password</label>
            <input type="password" placeholder='Password' className='pl-2 placeholder:font-bold  border rounded w-100 h-10  focus:outline-red-600' />
            <NavLink to="/sendmail" className='text-sm text-blue-700 w-100'>Forgot password?</NavLink>
          </div>
          <div className='flex items-center justify-center'>
            <button className='border rounded font-bold font-[poppins] w-100 h-10  bg-red-400 text-white'>Login</button>
          </div>
