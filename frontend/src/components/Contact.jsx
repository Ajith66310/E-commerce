...
const Contact = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fafafa] to-[#f0f0f0] px-6 py-20 font-[Inter]">
      {/* Header Section */}
      <div className="text-center max-w-3xl mx-auto mb-20">
        ...
        <p className="text-gray-600 text-lg leading-relaxed">
          Whether you have a question about your order, need styling advice, or just want to say hello — 
          we’d love to hear from you. Our fashion experts are always here to help.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 bg-white/70 backdrop-blur-lg shadow-2xl rounded-3xl overflow-hidden border border-gray-200">
        {/* Left Section */}
        <div className="bg-gradient-to-br from-black via-gray-900 to-red-800 text-white p-12 flex flex-col justify-between">
          <div>
            <h2 className="text-3xl font-[Playfair_Display] mb-4">Get in Touch</h2>
            <p className="text-gray-300 leading-relaxed mb-8">
              Reach us anytime — our dedicated team ensures your style and satisfaction 
              are always top priority.
            </p>

            <ul className="space-y-6 text-gray-300">
              <li>
                <p className="text-sm uppercase tracking-widest text-gray-400 mb-1">Phone</p>
              ...
              <li>
                <p className="text-sm uppercase tracking-widest text-gray-400 mb-1">Address</p>
