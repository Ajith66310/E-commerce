...
const SendMail = () => {
  ...
  return (
    <>
      <div className='pt-60 flex  h-[100vh] justify-center bg-[#FAF9F6]'>
        {
          otpSended ?

            <form action="" method='' onSubmit={handleVerifyOtp} className=' w-[80%] h-120' >
              <div className='flex justify-center items-center  mb-5 flex-col gap-1'>
            ...
            :
            <form action="" method='' onSubmit={handleResetMail} className=' w-[80%] h-120'>
